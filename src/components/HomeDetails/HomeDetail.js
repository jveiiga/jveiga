...
import { Container, Content, Image, Overlay, TitleContentImage, ToggleButton, TextContent, ImageWrapper, TextWrapper, ToogleWrapper } from './HomeDetailStyled';
  ...
  return (
    <Container darkMode={darkMode}>
      <ImageWrapper ref={imageRef} isVisible={imageIsVisible}>
        ...
        <Overlay>
          <TitleContentImage>
            <strong>Desenvolvimento&nbsp;</strong><h2>Web</h2>
          </TitleContentImage>
        </Overlay>
      </ImageWrapper>
        ...
        <Content ref={ref} className={isVisible ? 'animate' : ''}>
          ...
          <TextContent>
            <article id="desenvolvimento-web">
              <header>
                <h1>Desenvolvimento Web: Soluções Estratégicas para Fortalecer Sua Presença Digital</h1>
              </header>
              ...
              <section id="dw-sites-institucionais">
                ...
                <p>
                  Para empresas que buscam transmitir seriedade, confiança e profissionalismo, um site institucional é fundamental. Nossa equipe desenvolve plataformas robustas e elegantes, pensadas para comunicar a essência de sua marca e reforçar sua credibilidade no mercado. Cada detalhe – desde a identidade visual até a usabilidade – é projetado para proporcionar uma experiência única ao usuário.
                </p>
                <p>
